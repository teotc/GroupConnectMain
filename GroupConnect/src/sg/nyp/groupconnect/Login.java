...
public class Login extends Activity implements OnClickListener{
   ...
   // private static final String LOGIN_URL = "http://xxx.xxx.x.x:1234/webservice/login.php";
    ...
    private static final String LOGIN_URL = "http://"
			+ "www.it3197Project.3eeweb.com/webservice/loginTC.php";
  ...
  //testing from a real server:
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//setup buttons
		mSubmit = (Button)findViewById(R.id.loginLoginBn);
		mRegister = (Button)findViewById(R.id.loginRegisterBn);
	...
	public void onClick(View v) {
		// TODO Auto-generated method stub
		switch (v.getId()) {
		case R.id.loginLoginBn:
				new AttemptLogin().execute();
			break;
		case R.id.loginRegisterBn:
